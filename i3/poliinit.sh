...
export FULLBATTERY="%{T5}$(echo -e "\Uf12a3")%{T1} "
export CHARGEBATTERY="%{T5}$(echo -e "\Uf12a6")%{T1} "
export LOWBATTERY="%{T5}$(echo -e "\Uf12a2")%{T1} "


# Launch bar1 and bar2
echo "---" 
polybar example -c /home/gustavo/.config/polybar/config.ini
export MONITOR="$(echo -ne HDMI-1)"
